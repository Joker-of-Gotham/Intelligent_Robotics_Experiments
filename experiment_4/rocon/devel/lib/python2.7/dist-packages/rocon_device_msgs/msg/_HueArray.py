  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.modelid = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.swvesion = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v2.color = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v4.color = str[start:end].decode('utf-8', 'rosmsg')
        else:
