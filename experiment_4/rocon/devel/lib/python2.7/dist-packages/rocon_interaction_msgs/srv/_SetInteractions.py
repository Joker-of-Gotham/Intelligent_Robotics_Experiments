  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.rapp = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v3.resource_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v3.format = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        for i in range(0, length):
          ...
          if python3:
            val2.remap_from = str[start:end].decode('utf-8', 'rosmsg')
          else:
          ...
          if python3:
            val2.remap_to = str[start:end].decode('utf-8', 'rosmsg')
          else:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.namespace = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.parameters = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v7.resource_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v7.format = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v8.resource_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v8.format = str[start:end].decode('utf-8', 'rosmsg')
        else:
