...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.interaction.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.interaction.command = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.interaction.compatibility = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.interaction.group = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.interaction.description = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.interaction.icon.resource_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.interaction.icon.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.interaction.namespace = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.remap_from = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.remap_to = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      if python3:
        self.interaction.parameters = str[start:end].decode('utf-8', 'rosmsg')
      else:
