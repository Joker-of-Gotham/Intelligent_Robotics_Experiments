  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v2.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v2.value = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.start = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.finish = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v4.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v4.value = str[start:end].decode('utf-8', 'rosmsg')
        else:
