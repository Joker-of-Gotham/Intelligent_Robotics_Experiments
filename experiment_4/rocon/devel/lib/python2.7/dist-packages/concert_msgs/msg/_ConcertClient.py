...
string value"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.gateway_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.platform_info.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.platform_info.rocon_uri = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.platform_info.description = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.platform_info.icon.resource_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.platform_info.icon.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.platform_info.version = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.display_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.compatibility = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.preferred = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v2.resource_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v2.format = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v4.resource_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v4.format = str[start:end].decode('utf-8', 'rosmsg')
        else:
