    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            val2.rapp = str[start:end].decode('utf-8', 'rosmsg')
          else:
          ...
          if python3:
            val2.uri = str[start:end].decode('utf-8', 'rosmsg')
          else:
          ...
          for i in range(0, length):
            ...
            if python3:
              val3.remap_from = str[start:end].decode('utf-8', 'rosmsg')
            else:
            ...
            if python3:
              val3.remap_to = str[start:end].decode('utf-8', 'rosmsg')
            else:
        ...
        if python3:
          val1.problem = str[start:end].decode('utf-8', 'rosmsg')
        else:
