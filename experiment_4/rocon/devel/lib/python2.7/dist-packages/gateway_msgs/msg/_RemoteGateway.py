  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v3.type = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v3.node = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v4.node = str[start:end].decode('utf-8', 'rosmsg')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v7.type = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          _v7.node = str[start:end].decode('utf-8', 'rosmsg')
        else:
