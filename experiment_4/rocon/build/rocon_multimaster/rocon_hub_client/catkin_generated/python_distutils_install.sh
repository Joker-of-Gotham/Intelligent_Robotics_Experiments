...
echo_and_run cd "/home/haiden/rocon/src/rocon_multimaster/rocon_hub_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_multimaster/rocon_hub_client/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_multimaster/rocon_hub_client" \
    install \
    --root="${DESTDIR-/}" \
