...
echo_and_run cd "/home/haiden/rocon/src/rocon_multimaster/rocon_hub"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_multimaster/rocon_hub/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_multimaster/rocon_hub" \
    install \
    --root="${DESTDIR-/}" \
