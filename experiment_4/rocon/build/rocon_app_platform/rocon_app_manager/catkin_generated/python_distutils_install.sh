...
echo_and_run cd "/home/haiden/rocon/src/rocon_app_platform/rocon_app_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_app_platform/rocon_app_manager/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_app_platform/rocon_app_manager" \
    install \
    --root="${DESTDIR-/}" \
