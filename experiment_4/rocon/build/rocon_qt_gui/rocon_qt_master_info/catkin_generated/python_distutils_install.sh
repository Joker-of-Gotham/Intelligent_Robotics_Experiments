...
echo_and_run cd "/home/haiden/rocon/src/rocon_qt_gui/rocon_qt_master_info"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_qt_gui/rocon_qt_master_info/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_qt_gui/rocon_qt_master_info" \
    install \
    --root="${DESTDIR-/}" \
