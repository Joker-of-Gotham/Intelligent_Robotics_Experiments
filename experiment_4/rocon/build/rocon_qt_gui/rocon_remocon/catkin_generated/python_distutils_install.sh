...
echo_and_run cd "/home/haiden/rocon/src/rocon_qt_gui/rocon_remocon"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_qt_gui/rocon_remocon/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_qt_gui/rocon_remocon" \
    install \
    --root="${DESTDIR-/}" \
