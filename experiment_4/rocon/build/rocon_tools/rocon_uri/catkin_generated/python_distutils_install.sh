...
echo_and_run cd "/home/haiden/rocon/src/rocon_tools/rocon_uri"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_tools/rocon_uri/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_tools/rocon_uri" \
    install \
    --root="${DESTDIR-/}" \
