...
echo_and_run cd "/home/haiden/rocon/src/rocon_tools/rocon_python_utils"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_tools/rocon_python_utils/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_tools/rocon_python_utils" \
    install \
    --root="${DESTDIR-/}" \
