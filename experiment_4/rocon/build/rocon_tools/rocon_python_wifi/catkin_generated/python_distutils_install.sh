...
echo_and_run cd "/home/haiden/rocon/src/rocon_tools/rocon_python_wifi"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_tools/rocon_python_wifi/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_tools/rocon_python_wifi" \
    install \
    --root="${DESTDIR-/}" \
