...
echo_and_run cd "/home/haiden/rocon/src/rocon_tools/rocon_interactions"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/rocon/src/rocon_tools/rocon_interactions/setup.py" \
     \
    build --build-base "/home/haiden/rocon/build/rocon_tools/rocon_interactions" \
    install \
    --root="${DESTDIR-/}" \
