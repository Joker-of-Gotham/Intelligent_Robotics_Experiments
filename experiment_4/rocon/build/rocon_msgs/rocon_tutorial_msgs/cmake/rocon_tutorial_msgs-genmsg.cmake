...
get_filename_component(_filename "/home/haiden/rocon/src/rocon_msgs/rocon_tutorial_msgs/srv/GetAvailableResources.srv" NAME_WE)
add_custom_target(_rocon_tutorial_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rocon_tutorial_msgs" "/home/haiden/rocon/src/rocon_msgs/rocon_tutorial_msgs/srv/GetAvailableResources.srv" ""
)
...
_generate_srv_cpp(rocon_tutorial_msgs
  "/home/haiden/rocon/src/rocon_msgs/rocon_tutorial_msgs/srv/GetAvailableResources.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rocon_tutorial_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rocon_tutorial_msgs\")")
  # install generated code
  install(
