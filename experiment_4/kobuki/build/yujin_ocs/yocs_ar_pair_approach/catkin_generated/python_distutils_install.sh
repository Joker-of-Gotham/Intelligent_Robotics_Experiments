...
echo_and_run cd "/home/haiden/kobuki/src/yujin_ocs/yocs_ar_pair_approach"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/kobuki/src/yujin_ocs/yocs_ar_pair_approach/setup.py" \
     \
    build --build-base "/home/haiden/kobuki/build/yujin_ocs/yocs_ar_pair_approach" \
    install \
    --root="${DESTDIR-/}" \
