...
echo_and_run cd "/home/haiden/kobuki/src/yujin_ocs/yocs_localization_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/kobuki/src/yujin_ocs/yocs_localization_manager/setup.py" \
     \
    build --build-base "/home/haiden/kobuki/build/yujin_ocs/yocs_localization_manager" \
    install \
    --root="${DESTDIR-/}" \
