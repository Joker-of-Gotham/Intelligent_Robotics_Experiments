...
echo_and_run cd "/home/haiden/kobuki/src/kobuki_desktop/kobuki_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/kobuki/src/kobuki_desktop/kobuki_dashboard/setup.py" \
     \
    build --build-base "/home/haiden/kobuki/build/kobuki_desktop/kobuki_dashboard" \
    install \
    --root="${DESTDIR-/}" \
