...
echo_and_run cd "/home/haiden/kobuki/src/kobuki_desktop/kobuki_qtestsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/kobuki/src/kobuki_desktop/kobuki_qtestsuite/setup.py" \
     \
    build --build-base "/home/haiden/kobuki/build/kobuki_desktop/kobuki_qtestsuite" \
    install \
    --root="${DESTDIR-/}" \
