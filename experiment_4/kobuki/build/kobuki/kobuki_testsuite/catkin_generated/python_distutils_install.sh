...
echo_and_run cd "/home/haiden/kobuki/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/haiden/kobuki/src/kobuki/kobuki_testsuite/setup.py" \
     \
    build --build-base "/home/haiden/kobuki/build/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
